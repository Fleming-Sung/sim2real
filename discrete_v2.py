...
if __name__ == "__main__":
    ...
    for i in range(1000000):
        ...
        dbullet = 0 # 是否 射击
        action = [dx, dy, dtheta, dbullet] # 动作
        ...
        reward = reward - get_dist(next_obs, goal) - 70 * (next_vector_data[10][1] - vector_data[10][1]) - 30 * (next_vector_data[10][0] - vector_data[10][0])
        ...
        # 当前局结束
        if idx > 500 or bool_done or done:
            episode = episode + 1
